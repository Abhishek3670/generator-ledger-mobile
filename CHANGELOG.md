...
## [0.4.0] - 2026-04-09
### Added
- Theme directory for centralized design tokens and theming.
- Shared component library (AppBottomNav, CorporateAppBar, StatusAlertCard, DashboardAssetRow).
- Bookings grouped by vendor with expandable sections for improved readability.
- Summary banners for financial metrics (total revenue/pending) in Billing screen.
- Rate management dialog and payment status toggling in Billing module.
- Corporate app bar across all screens for consistent branding.

### Changed
- Converted Billing screen to grid-based DataTable for better data density.
- Modernized Dashboard screen with modular asset rows and cleaner calendar.
- Redesigned Admin screen with grouped settings sections and sign-out flow.
- Refactored Directory screen to pre-fetch data on init for smoother navigation.

### Performance
- Enhanced UI consistency with design system tokens and reusable widgets.
